...
window.updateSettings = function (context, ignoreHidden, ignoreLocked) {
  document.getElementById("context-".concat(context)).checked = true;
  document.getElementById("ignore-hidden").checked = ignoreHidden;
  document.getElementById("ignore-locked").checked = ignoreLocked;
};

document.getElementById("context-artboard").addEventListener("change", function (e) {
  if (e.currentTarget.checked) {
    window.postMessage("context", "artboard");
  }
});
document.getElementById("context-group").addEventListener("change", function (e) {
  if (e.currentTarget.checked) {
    window.postMessage("context", "group");
  }
});
document.getElementById("ignore-hidden").addEventListener("change", function (e) {
  window.postMessage("ignoreHidden", e.currentTarget.checked);
});
document.getElementById("ignore-locked").addEventListener("change", function (e) {
