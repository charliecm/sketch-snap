...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/a55856e2e2168572487682e7fcc47773.html";
...
var webviewIdentifier = "sketch-snap.webview";
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  webContents.on("did-finish-load", function () {
    ...
    webContents.executeJavaScript("updateSettings(\"".concat(context, "\", ").concat(ignoreHidden, ", ").concat(ignoreLocked, ")"));
  });
